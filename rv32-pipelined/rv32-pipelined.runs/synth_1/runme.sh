...
HD_PWD='/home/thejoey/Projects/simple_cpus/rv32-pipelined/rv32-pipelined.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log riscv_cpu_tb.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source riscv_cpu_tb.tcl
